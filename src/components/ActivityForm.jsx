...
function ActivityForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const activityValid = validateActivity(
      ...
      currentDate,
      parseInt(formData.hour * 60 + formData.min)
    );
  ...
  const postData = async () => {
    ...
    await axios
      .post("https://infinityfitbackenddev.onrender.com", postObject, config)
      .then((res) => {
        console.log(res);
      ...
      <div className="row-1">
        <div className="form">
          <form>
            ...
            <div className="form-group">
              <label style={{ marginRight: "20px" }} htmlFor="duration">
                Date
              </label>
              <DateTimePicker
        ...
        <div className="img-parent">
          ...
          <svg
            className="w-10 h-10 camera-icon"
            onClick={() => {
              fileInput.click();
            }}
